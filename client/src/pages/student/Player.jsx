...
useEffect(()=>{
 ...
 const markLectureAsCompleted = async(lectureId)=>{
  try {
    ...
    console.log(data);
    console.log("Sending to backend:", { courseId, lectureId });
...
{/* left column */}
      <div className='text-gray-800'>
        ...
        <div className='pt-5'>
          ...
          progressData.lectureCompleted.includes(lecture.lectureId) ? assets.blue_tick_icon : assets.play_icon} alt="play icon" className='w-4 h-4 mt-1'/>

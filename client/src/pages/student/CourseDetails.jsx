...
const toggleSection =(index)=>{
  ...
  return courseData ? (
    ...
    justify-between md:px-36 md:pt-30 pt-20 text-left '>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
       ...
       {/* review and rating */}
          <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
            ...
            <p>Course by <span className='tect-blue-600 underline'>GreatStack</span></p>
             ...
             <div className='flex items-center text-sm md:text-default gap-4 pt-2
              ...
              <div>
                ...
                <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                  <li>Lifetime accesss with free updates.</li>
